...
class AddressBar extends React.Component {
  ...
  render () {
    ...
    return (<div>
      <label>Address</label>
      <br/> 
      <input size='80' onChange={this.handleChange} placeholder='uri' value={this.state.subject} /> <a href={this.state.subject} target="_blank"><img height="10" width="10" src="./image/External.svg" /></a>
      <hr />
