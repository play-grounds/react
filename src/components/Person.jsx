...
function getAvatarFromSubject (subject) {
  let profile = getProfileFromSubject(subject)
  let avatar =
    profile.img || profile.image || profile.depiction || profile.hasPhoto
  return avatar
}
...
class Person extends React.Component {
  ...
  render () {
    ...
    let name = this.state.profile
      ? getNameFromSubject(this.state.subject)
      : 'has no name'
    let avatar =
      getAvatarFromSubject(this.state.subject) ||
    ...
    return (
      <div className='card'>
        ...
        <div className='card-content'>
          ...
          <div className='content'>
            <a target='_blank' href={'./timeline.html?uri=' + profile.timeline}>
              Timeline
            </a>
            <br />
          </div>
