  ...
  return (
    <div className='is-info'>
      ...
      <div className='buttons'>
        <span className='button is-large is-success'>Win : {w}%</span>
        <span className='button is-large is-info'>Draw : {d}%</span>
        <span className='button is-large is-danger'>Loss : {l}%</span>
...
ReactDOM.render(
  <Provider stores={[store]}>
    <NavbarSolidLogin
      className='is-link'
      title='Grigget App'
      sourceCode='https://github.com/play-grounds/react/blob/gh-pages/play/grigget.html/'
    />
